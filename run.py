...
def get_sales_data():
    ...
    Run a while loop to collect a valid of data from the user via the terminal, which must be a string
    of 6 numbers separated by commas. The loop will repeatedly request data, until it is valid.
    """
    while True:
...
"""
Old code replaced with update_worksheet() function.
Code was used to update sales and surplus sheet in google sheets
...
def get_last_5_entries_sales():
    """
    Collects collumns of data from sales worksheet, collecting the last 5 entries for
